...
if (!isset($_SESSION["mikhmon"])) {
  ...
  $udates = mikhmon_parse_user_comment_dates($ucomment);
  $uactivation = $udates['end'] ? $udates['end'] : '-';
  $uexpiration = $udates['end'] ? $udates['end'] : '-';
// share WhatsApp
  if ($getvalid != "") {
...
<div class="group-item group-item-r pd-2p5 text-center">
  ...
  <tr>
    <td class="align-middle">Activation</td><td><input class="form-control" type="text" value="<?= $uactivation; ?>" disabled></td>
  </tr>
  <tr>
    <td class="align-middle">Expiration</td><td><input class="form-control" type="text" value="<?= $uexpiration; ?>" disabled></td>
  </tr>
  <tr>
