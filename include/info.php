 ...
 */
if (substr($_SERVER["REQUEST_URI"], -8) == "info.php") { header("Location:./"); exit; }
// Both menu.php and admin.php include this footer; render it once per page.
if (defined('MIKHMON_INFO_RENDERED')) { return; }
define('MIKHMON_INFO_RENDERED', true);
?>
